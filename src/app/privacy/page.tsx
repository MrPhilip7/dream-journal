...
import { Shield, Download, Trash2, Key, Eye, EyeOff, AlertTriangle } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Please sign in to access privacy settings.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Privacy & Security</h1>
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-card rounded-xl shadow-sm border border-border p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-card-foreground mb-2">Content Encryption</h3>
                  <p className="text-muted-foreground mb-4">
                    Enable client-side encryption to protect your dream content. Your data will be encrypted before being stored on our servers.
                  </p>
            ...
            <div className="bg-card rounded-xl shadow-sm border border-red-200 p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-card-foreground mb-2">Delete Account</h3>
                  <p className="text-muted-foreground mb-4">
